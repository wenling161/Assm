    ...
    <div class="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicatorss">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="picturefolder/homepage/graduationhome.jpg" alt="" />
            </div>
        </div>
    </div>
        ...
        <div class="row">
         ...
         <div class="col mt-5">
             <div class="eventLocation">
                <div class="h1" style="padding-left: 60px;"><span style="color: black;" class="badge bg-secondary text-wrap text-uppercase">Location</span></div>
            </div>
             </div>
        <div class="map">
